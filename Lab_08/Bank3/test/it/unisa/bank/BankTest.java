...
public class BankTest {
    ...
    @Test
    public void checkNegativeBankAccountBalanceTest() {
        Bank b = new Bank();
        Assert.assertThrows(IllegalArgumentException.class, () -> b.addAccount(new BankAccount("Harry", -1000)));
    }

    @Test
    public void checkNegativeDepositAndWithdrawTest() {
        Bank b = new Bank();
        b.addAccount(new BankAccount("Harry", 1000));
        Assert.assertThrows(IllegalArgumentException.class, () -> b.deposit(1, -1000));
        Assert.assertThrows(IllegalArgumentException.class, () -> b.withdraw(1, -1000));
    }
}